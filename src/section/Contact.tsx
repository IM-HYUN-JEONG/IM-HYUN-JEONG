...
export default function Contact() {
  const copyEmailToClipboard = () => {
    navigator.clipboard.writeText('fltxld1@gmail.com');
      ...
      <Stack direction={'column'} justifyContent={'center'} alignItems={'center'}>
        <StyledPaper elevation={3}>
          ...
          <Stack direction={'row'} justifyContent={'center'} alignItems={'center'}>
            ...
            <Link href={'https://www.linkedin.com/in/imhyunjeong97/'} style={{ textDecoration: 'none' }}>
              <IconButton aria-label="open linkedin button">
                <Image src={`/icons/linkedin.svg`} height={40} width={40} alt={'linkedin'} />
              </IconButton>
            </Link>

            <Link href={'https://open.kakao.com/o/sJzy9L4g'} style={{ textDecoration: 'none' }}>
